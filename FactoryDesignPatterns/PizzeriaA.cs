...
{
    public class PizzeriaA : IPizzaria
    {
        ...
        {
            return Sauce.CherryTomato.ToString();
        }

        public string GetDough()
        {
            return Dough.ThinCrust.ToString();
        }

        public string GetClam()
        {
            return Clam.FrozenClam.ToString();
        }

        public string GetBoxColor()
        {
            return ColorBox.Red.ToString();
        }

        public string GetCheese()
        {
            return Cheese.Mozzarella.ToString();
        }
